...
const ensureGridApiHasBeenSet = (container) => {
  return new Promise(function (resolve, reject) {
    (function waitForGridReady() {
      if (getByTestId(container, 'api').innerHTML !== '') {
        return resolve();
      }
...
test("AG Grid renders the table", async () => {
  ...
  await waitFor(() => ensureGridApiHasBeenSet(container));
